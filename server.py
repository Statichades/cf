...
# --- CONFIGURATION ---
EMAIL_USER = "joseken440@gmail.com" #your email here
EMAIL_PASS = "emke gleg qrwz cvrs" #your email app password here (not email password)
...
def log_success():
    ...
    conn.commit()
    conn.close()
    print(f"✅ SUCCESS: {ref_code} (+10 Flames) | phcorner.org | Chisato-Chan")
    return "OK"
